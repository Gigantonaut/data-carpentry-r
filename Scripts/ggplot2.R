library (ggplot2)
interviews_plotting <- readRDS("~/Macquarie University/PhD/2018_2019/Research/Microwear/RStudio/data-carpentry-r/Data/Interviews_plotting.rds")

##ggplot (data = <DATA>,
##bmapping = aes (<MAPPINGS>)) + <GEOM_FUNCTION>()
